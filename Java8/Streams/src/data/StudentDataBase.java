...
public class StudentDataBase {
     ...
     * @return
     */
    public static Supplier<Student> getStudent = ()-> {return new Student("Adam",2,3.6, "male",Arrays.asList("swimming", "basketball","volleyball"));};
    public static List<Student> getAllStudents(){
        ...
        Student student4 = new Student("Dave",3,3.9,"male", Arrays.asList("swimming", "gymnastics","soccer"),12);
        /**
         * 4th grade students
         */
